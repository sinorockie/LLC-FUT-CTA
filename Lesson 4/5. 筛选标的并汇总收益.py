...
for i in range(len(trade_date_series)):
    if trade_date_series[i] == start_date:
        ...
        # 从大到小排序的前20%品种
        carry_ma10_map_first_20 = carry_ma10_map_list[:int(len(carry_ma10_map_list) * 0.15)]
        print(carry_ma10_map_first_20)
        # 从小到大排序的前20%品种
        carry_ma10_map_last_20 = carry_ma10_map_list[-int(len(carry_ma10_map_list) * 0.15):]
